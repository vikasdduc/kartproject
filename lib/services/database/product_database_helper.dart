...
class ProductDatabaseHelper{
  ...
  static const String REVIEW_COLLECTION_NAME = "reviews";
  ...
  Future<List<String>> searchInProduts(String query,
  ...
  Future<bool> addUsersRatingForProduct(String productId, int rating,
    ...
    final ratingsCount =
        (await productDocRef.collection(REVIEW_COLLECTION_NAME).get())
            .docs
            .length;
