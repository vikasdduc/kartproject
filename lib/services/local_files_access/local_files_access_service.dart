...
import 'package:kartforyou/exceptions/local_files_handling/image_picking_exceptions.dart';
import 'package:kartforyou/exceptions/local_files_handling/local_file_handling_exception.dart';
...
Future<String> choseImageFromLocalFiles(
  ...
  final PickedFile? imagePicked = (await imgPicker.pickImage(source: imgSource)) as PickedFile?;
  if (imagePicked == null) {
    throw LocalImagePickingInvalidImageException();
  } else {
